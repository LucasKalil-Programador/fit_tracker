          ...
          children: [
            Expanded(
              child: ElevatedButton(
                ...
                child: Text(widget.rejectText ?? localization.reject),
              ),
            ),
            ...
            Expanded(
              child: ElevatedButton(
                ...
                child: secondsLest <= 0 ? Text(widget.acceptText ?? localization.accept) : Text(localization.secondsLeft(secondsLest)),
              ),
            ),
          ],
        ),
