  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Dismissible(
        ...
        onDismissed: (direction) => Provider.of<ExerciseListState>(context, listen: false).removeExercise(exercise),
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Padding(
          ...
          child: ExerciseForm(
            onSubmit: (value) {
              Provider.of<ExerciseListState>(context, listen: false,).updateExercise(exercise, value);
